...
<div class="container">
	...
	<?php echo form_open_multipart(base_url('order/do_submit')) ?>
		...
		<table class="form">
			...
			<td>
				...
				<select name="Job" id="Job">
					<option value="<?php echo set_value('Job') ?>"><?php echo set_value('Job') ?></option>
			...
			<td>
				...
				<select name="Client" id="Client">
					<option value="<?php echo set_value('Client') ?>"><?php echo set_value("Client") ?></option>
			...
			<td>
				...
				<select name="PM" id="PM">
					<option value="<?php echo set_value('PM') ?>"><?php echo set_value('PM') ?></option>
			...
			<td>
				...
				<select name="jobstat" id="jobstat">
					<option value="<?php echo set_value('jobstat') ?>"><?php echo set_value('jobstat') ?></option>
			...
			<td>Date Shipped</td>
			<td>
				<input type="text" name="dateship" id="dateship" size="32" value="<?php echo set_value('dateship',date('Y-m-d')) ?>">
				<?php echo form_error("dateship") ?>
			</td><tr>

			<td>Directory Info</td>
			<td>
				<input type="text" name="DirectoryInfo" id="DirectoryInfo" size="32" value="<?php echo set_value('DirectoryInfo') ?>">
				<?php echo form_error("DirectoryInfo") ?>
			</td><tr>

			<td>Tracking No</td>
			<td>
				<input type="text" name="TrackingNumber" id="TrackingNumber" size="32" value="<?php echo set_value('TrackingNumber') ?>">
				<?php echo form_error("TrackingNumber") ?>
			</td><tr>

			<td>COMMENT</td>
			<td>
				<textarea name="Comment" id="Comment" cols="90" rows="10"><?php echo set_value("Comment") ?></textarea>
			</td><tr>
